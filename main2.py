...
gt.calculateSRTVertexes(test.vertexes, Vertex(-400, -300, 1), Vertex(400, 300, 1), Vertex(0, 0, 1), Vertex(800, 600, 1), dp)


for edge in test.edges:
  print(edge.startVertex.coordinatesXY())
  
  canvas.create_line(edge.startVertex.coordinatesXY(), edge.endVertex.coordinatesXY(), fill="red")
